public class MaquinaExpendedoraMejorada {
    ...
    public void introducirDinero(int cantidadIntroducida) {
        if (billetesVendidos < numeroMaximoBilletes) {
            ...
            System.out.println("Billetes agotados. No se pueden comprar más billetes");
        }
    }
    ...
    public int vaciarDineroDeLaMaquina() {
        ...
        if (balanceClienteActual == 0) {
            ...
            System.out.println("No se puede vaciar el dinero, hay una operación en marcha");
            System.out.println("Cancela la operación y retira el dinero del cliente");
